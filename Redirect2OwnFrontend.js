...
// @namespace -
// @version 11.2.0
// @description Redirects you from proprietary web-services to ethical alternatives(front-end). Based on 'Open-Source Alternative Redirector.user.js' by NotYou
...
// @grant none
// @downloadURL https://###/Open-Source%20Alternative%20Redirector.user.js
// @updateURL https://###/Open-Source%20Alternative%20Redirector.meta.js
// ==/UserScript==
...
(function() {
    ...
    let { host, href, search } = location,
        ...
        // INSTANCES //
        invidious     = '1.new-domain.de', //youtube
        searx         = '2.new-domain.it', //google
        libreddit     = '3.new-domain.net', //reddit
        nitter        = '4.new-domain.is', //twitter
        wikiless      = '5.new-domain.au', //wikiopedia
        lingva        = '6.new-domain.mx', //gtranslate
        scribe        = '7.new-domain.ae', //medium
        rimgo         = '8.new-domain.am', //imgur
        proxitok      = '9.new-domain.ro', //tiktok
        quetre        = '10.new-domain.ch', //Quora
        hyperpipe     = '11.new-domain.info', //YouTube Music 
        librarian     = '.new-domain.zone', //
        bibliogram    = '.new-domain.com', //
